      ...
      <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor"><i class="fa fa-braille" style="color:#1976d2"></i>&nbsp Панель управление </h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)"><i class="mdi mdi-home-assistant"></i> Главная </a></li>
                        <li class="breadcrumb-item active"><i class="fa fa-braille"></i> Админ Панел </li>
                    </ol>
                </div>
            </div>
            <!-- Container fluid  -->
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-row">
                                    ...
                                    ?>  Cотрудники </h3>
                                        <a href="<?php echo base_url(); ?>employee/Employees" class="text-muted m-b-0"><i class="mdi mdi-chevron-double-right"></i> Посмотреть все детали </a></div>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="m-l-10 align-self-center">
                                        <h3 class="m-b-0">
                                             <?php 
                                                    ...
                                                    echo $this->db->count_all_results();
                                                ?> Заявление листы </h3>
                                        	<a href="<?php echo base_url(); ?>leave/Application" class="text-muted m-b-0"><i class="mdi mdi-chevron-double-right"></i> Посмотреть все детали </a>
                                        </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="m-l-10 align-self-center">
                                        <h3 class="m-b-0"> 
                                         <?php 
                                                ...
                                                echo $this->db->count_all_results();
                                            ?> Проекты </h3>
                                        	<a href="<?php echo base_url(); ?>Projects/All_Projects" class="text-muted m-b-0"><i class="mdi mdi-chevron-double-right"></i> Посмотреть все детали  </a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="m-l-10 align-self-center">
                                        <h3 class="m-b-0">
                                         <?php 
                                                ...
                                                $this->db->from("loan");
                                                echo $this->db->count_all_results();
                                            ?> Зарплаты и Авансы </h3>
                                        <a href="<?php echo base_url(); ?>Loan/View" class="text-muted m-b-0"><i class="mdi mdi-chevron-double-right"></i> Посмотреть все детали </a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 col-lg-3 col-xlg-3">
                        <div class="card card-inverse card-info">
                            <div class="box bg-primary text-center">
                                ...
                                <h6 class="text-white"> Бывшие сотрудники </h6>
                            </div>
                        </div>
                    </div>
                    <!-- Column -->
                    <div class="col-md-6 col-lg-3 col-xlg-3">
                        <div class="card card-info card-inverse">
                            <div class="box text-center">
                                ...
                                <h6 class="text-white"> Заявление на отпуск в ожидании </h6>
                            </div>
                        </div>
                    </div>
                    <!-- Column -->
                    <div class="col-md-6 col-lg-3 col-xlg-3">
                        <div class="card card-inverse card-danger">
                            <div class="box text-center">
                                ...
                                <h6 class="text-white"> Предстоящий проект </h6>
                            </div>
                        </div>
                    </div>
                    <!-- Column -->
                    <div class="col-md-6 col-lg-3 col-xlg-3">
                        <div class="card card-inverse card-success">
                            <div class="box text-center">
                                ...
                                <h6 class="text-white"> Заявление на Зарплаты и Авансы </h6>
                            </div>
                        </div>
                    </div>
                    <!-- Column -->
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title"><i class="mdi mdi-projector-screen" aria-hidden="true"></i> Текущий проекты </h4>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table class="table table-bordered table-hover earning-box">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><i class="fa fa-calendar-plus-o" aria-hidden="true"></i> Дата начала </th>
                                                <th><i class="fa fa-calendar-check-o" aria-hidden="true"></i> Дата окончания </th>
                                            </tr>
                                        </thead>
                                        <tbody>
                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title"><i class="fa fa-indent" aria-hidden="true"></i> Список делы </h4>
                                <h6 class="card-subtitle"> Список вашей следующей задачи для завершения </h6>
                                ...
                                <div class="new-todo">
                                   <form method="post" action="add_todo" enctype="multipart/form-data" id="add_todo" >
                                    <div class="input-group">
                                        <input type="text" name="todo_data" class="form-control" style="border: 1px solid #fff !IMPORTANT;" placeholder="Введите новую задачу...">
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title"><i class="fa fa-newspaper-o" aria-hidden="true"></i> Доска объявлений </h4>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive slimScrollDiv" style="height:600px;overflow-y:scroll">
                                    <table class="table table-hover table-bordered earning-box ">
                                        <thead>
                                            <tr>
                                                <th><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Заголовок </th>
                                                <th><i class="fa fa-file-image-o" aria-hidden="true"></i> Файл </th>
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title"><i class="fa fa-birthday-cake" aria-hidden="true"></i> Праздничный день </h4>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive" style="height:600px;overflow-y:scroll">
                                    <table class="table table-hover table-bordered earning-box">
                                       <thead>
                                            <tr>
                                                <th><i class="fa fa-id-badge" aria-hidden="true"></i> Cотрудники </th>
                                                <th><i class="fa fa-calendar" aria-hidden="true"></i> Дата </th>
                                            </tr>                                           
                                       </thead>
                                       <tbody>
