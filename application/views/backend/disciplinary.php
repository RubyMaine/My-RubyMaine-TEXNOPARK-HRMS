         ...
         <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor"><i class="mdi mdi-buffer" style="color:#1976d2"></i> Дисциплинарный список </h3>
                </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row m-b-10"> 
                    <div class="col-12">
                        <button type="button" class="btn btn-success"><i class="fa fa-plus"></i><a data-toggle="modal" data-target="#exampleModal" data-whatever="@getbootstrap"  class="text-white"><i class="" aria-hidden="true"></i> Добавить дисциплину </a></button>
                        <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="<?php echo base_url(); ?>employee/Employees" class="text-white"> Список сотрудников </a></button>
                    </div>
                </div>         
                <div class="row">
                    <div class="col-12">
                        <div class="card card-outline-info">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white"><i class="mdi mdi-buffer" style="color:#1976d2"></i> Дисциплинарный список: </h4>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><i class="fa fa-pencil-square-o" aria-hidden="true" style="color:#1976d2"></i> Название: </th>
                                                <th><i class="mdi mdi-rename-box" style="color:#1976d2"></i> Описание: </th>
                                                <th><i class="mdi mdi-creation" style="color:#1976d2"></i> Статус: </th>
                                           ...
                                           <?php foreach($desciplinary as $value): ?>
                                            <tr>
                                                ...
                                                <td  class="jsgrid-align-center ">
                                                    <a href="#" title="Edit" class="btn btn-sm btn-primary waves-effect waves-light disiplinary" data-id="<?php echo $value->id; ?>"><i class="fa fa-pencil-square-o"></i> Редактировать </a>
